  ...
  return (
    <article className="max-w-3xl mx-auto px-6 pt-8 pb-32 text-right" dir="rtl">
      ...
      <div className="space-y-6 text-base md:text-lg leading-relaxed text-muted-foreground mb-16">
        ...
        <p>
          با وجود این ممکن است مشتریان محترم پس از خرید، با مسایلی روبرو شوند که در چنین مواردی خدماتی در چارچوب خدمات پس از فروش در نظر گرفته شده است. شما می‌توانید تا ۷ روز پس از دریافت کالا، در صورت عدم استفاده و حفظ شرایط اولیه، آن را مرجوع کنید.
        </p>
        <p>
          لطفاً توجه داشته باشید که لباس‌های زیر و اقلام بهداشتی به دلیل مسائل بهداشتی قابلیت تعویض و مرجوعی ندارند. برای ثبت درخواست مرجوعی، با پشتیبانی تماس بگیرید.
        </p>
      </div>
