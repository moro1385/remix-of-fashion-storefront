...
const collectionCards = [
  ...
  { dept: "kids", deptLabel: "بچه گانه", handle: "underwear", labelOverride: "Underwear/Shorts" },
    ...
    <section className="py-20 bg-[hsl(var(--warm-bg))]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-end justify-between gap-6 mb-10">
          <div>
            <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground mb-3">مرور</p>
